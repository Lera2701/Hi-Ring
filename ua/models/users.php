...
if ($_SESSION['rights'] === '1') {
    ...
    $table .= '<div class="editBlock">';
        ...
        $table .= '<div class="edit" id="edit">Редагувати</div>
                    <div class="delete" id="delete">Видалити</div>
                    <div class="add" id="addit">Додати</div>
                    <div class="save" id="save" style="display: none">Зберегти</div>';
    ...
    if ($i) {
        ...
        $table .= '</table><div class="save" id="saveAdd" >Зберегти</div>';
    }
}
