...
if ($_SESSION['rights'] === '1') {
    ...
    $table .= '<div class="edit" id="edit_works">Edit</div>
                    <div class="delete" id="delete_works">Delete</div>
                    <div class="add" id="addit_works">Add</div>
                    <div class="save" id="save_works" style="display: none">Save</div>';
    ...
    if ($i) {
        ...
        $table .= '</table><div class="save" id="saveAdd_works" >Save</div>';
    }
...
} else $table = 'No available records for you';
$table2 = '';
if ($_SESSION['rights'] === '4') {
        $table2 .= '<table id="additionalTask">';
        $table2 .= '<td><input class="shown" placeholder="Location"></td>
                    <td><input class="shown" placeholder="Start time"></td>
                    <td><input class="shown" placeholder="Responsible"></td>';
        $table2 .= '</table><div class="save" id="saveTask" >Save</div>';
}